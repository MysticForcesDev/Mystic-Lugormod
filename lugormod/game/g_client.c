...
#if 0// Xbox experiment, let's allow people to change sabers immediately:
...
//		ClientUserinfoChanged( ent->s.number );
		...
		else if (ent->client->saber[0].saberFlags & SFL_TWO_HANDED)//.twoHanded)
		{ //staff
